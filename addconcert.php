...
?>
            ...
            <div class="container-fluid">
                ...
                <h1 class="mt-4">Add New Concert</h1>
                <form action="saveconcert.php"  method="post" enctype="multipart/form-data" name="Add_Product" id="Add_Product" >
 
  
  <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td height="50" colspan="3" align="center">Insert Concert Table
     </td>
    </tr>
    <tr>
      <td width="129" align="right" valign="middle">ConcertID :</td>
      <td colspan="2"><label for="pro_name2"></label>
        <input name="ConcertID" type="text" required="required" id="pro_name2" size="50"/></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td colspan="2"><label for="pro_name2"></label>
        <input name="ConcertName" type="text" required="required" id="pro_name2" size="50"/></td>
    </tr>
    <tr>
      <td align="right" valign="middle">&nbsp;</td>
      <td colspan="2">&nbsp;</td>
    ...
    <tr>
      ...
      <td colspan="2"><label for="pro_name2"></label>
        <input name="DateSale" type="date" required="required" id="pro_name2" size="50"/></td>
    </tr>
    <tr>
      <td align="right" valign="middle">&nbsp;</td>
      <td colspan="2">&nbsp;</td>
    ...
    <tr>
      ...
      <td colspan="2"><label for="pro_name2"></label>
        <input name="TimeSale" type="time" required="required" id="pro_name2" size="50"/></td>
    </tr>
    <tr>
      <td align="right" valign="middle">&nbsp;</td>
      <td colspan="2">&nbsp;</td>
    ...
    <tr>
      ...
      <td colspan="2"><label for="pro_name2"></label>
        <input name="UnitPrice" type="number" required="required" id="pro_name2" size="50"/></td>
    </tr>
    <tr>
      <td align="right" valign="middle">&nbsp;</td>
      <td colspan="2">&nbsp;</td>
    ...
    <tr>
      ...
      <td colspan="2"><label for="pro_name2"></label>
        <input name="Amount" type="number" required="required" id="pro_name2" size="50"/></td>
    </tr>
    <tr>
      <td align="right" valign="middle">&nbsp;</td>
      <td colspan="2">&nbsp;</td>
    ...
    <tr>
      ...
      <td colspan="2"><label for="pro_name2"></label>
        <input name="AllAmount" type="number" required="required" id="pro_name2" size="50"/></td>
    </tr>
    <tr>
      <td align="right" valign="middle">&nbsp;</td>
      <td colspan="2">&nbsp;</td>
    ...
    <tr>
      ...
      <td colspan="2"><label for="pro_name2"></label>
        <input name="DateShow" type="date" required="required" id="pro_name2" size="50"/></td>
    </tr>
    <tr>
      <td align="right" valign="middle">&nbsp;</td>
      <td colspan="2">&nbsp;</td>
    ...
    <tr>
      ...
      <td colspan="2"><label for="pro_name2"></label>
        <input name="Location" type="text" required="required" id="pro_name2" size="50"/></td>
    </tr>
    <tr>
      <td align="right" valign="middle">&nbsp;</td>
      <td colspan="2">&nbsp;</td>
    ...
    <tr>
      ...
      <td colspan="2">
      <textarea name="Detail" id="pro_detail" cols="50" rows="3" required="required"></textarea></td>
    </tr>
    <tr>
      <td align="right" valign="middle">&nbsp;</td>
      <td colspan="2">&nbsp;</td>
    ...
    <tr>
      ...
      <td colspan="2"><label for="pro_img"></label>
        <input name="ImageFile" type="file" required="required" id="pro_img" size="40" /></td>
    </tr>
    <tr>
      <td align="right" valign="middle">&nbsp;</td>
      <td colspan="2">&nbsp;</td>
